...
python scripts/compare.py --batch_size=1 --input_dir 'datasets/DIV2K/test' --output_dir 'myresults/DIV2K_compare' 
python scripts/compare.py --batch_size=20 --input_dir 'datasets/images/test' --output_dir 'myresults/GOPRO_compare' 
